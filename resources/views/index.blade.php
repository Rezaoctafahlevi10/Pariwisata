    ...
    <div class="container text-center">
        <div class="row align-items-start">
          ...
          <div class="col">
            <div class="row mt-5">
				<h3>Data Wisata</h3>
					<a href="/index/tambah"><i class="fa-solid fa-plus" style="color: #636569;">TAMBAH</i></a>
			</div>
			<div class="col">
				<div class="row ">
						...
						<tr>
							...
							<td>
								<button type="button" class="btn btn-primary">
									<a href="/index/edit{{ $p->id }}">
										<i class="fa-regular fa-pen-to-square"style="color:orange"></i>
									</a>
								</button>
								{{-- <form action="{{ url('wisata/' .$p -> id) }}" method="post"class="d-inline"onsubmit="return confirm('Yakin hapus?')"></form>
									@method('remove')
									@csrf --}}
									<button type="button" class="btn btn-primary">
										<a href="/index/hapus/{{ $p->id }}">
